...
frame3d  ofxScrollView::getChildFrame(ofxScrollView *v){
...
void ofxScrollView::setFrame(frame3d frame){
    ...
    if (bounds.height != frame.h || bounds.width != frame.w) { // SCALED, refresh content size
        cdirty = true;
    }
